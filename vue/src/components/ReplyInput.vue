    ...
    <div class="reply-input">
      <div>
        <label
          ...
          class="direct-reply-label"
          for="direct-reply-input"
          >Reply to This Post</label
        >
        <div v-else>
          <label
            class="sub-reply-label"
            v-if="!this.targetReply.deleted"
            for="sub-reply-input"
            >Reply to {{ this.targetReply.usernameFrom }}</label
          >
          <label class="sub-reply-label" v-else for="sub-reply-input"
            >Reply to deleted reply</label
          >
        </div>
      </div>
      <div>
        <input
          v-if="this.isDirectReply"
          type="text"
          id="direct-reply-input"
          name="directReplyInput"
          v-model="replyInput.replyText"
        />
        <input
          v-else
          type="text"
